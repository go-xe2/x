...
type (
	IntIntMapForeachFunc func(k int, v int) bool
	IntIntMapLockFunc    func(m map[int]int)
)
...
func (m *TIntIntMap) doSetWithLockCheck(key int, value interface{}) int {
	m.mu.Lock()
	defer m.mu.Unlock()
