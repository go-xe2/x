...
type TSqlFunIfNull struct {
	*TSqlFun
	val1 interface{}
	val2 interface{}
}

var _ SqlFun = &TSqlFunIfNull{}

func NewSqlFunIfNull(val1 interface{}, val2 interface{}) SqlFun {
	inst := &TSqlFunIfNull{
		val1: val1,
		val2: val2,
	}
...
func (sf *TSqlFunIfNull) Compile(builder DbDriverSqlBuilder, cxt SqlCompileContext, unPrepare ...bool) SqlToken {
	if sf.val1 == nil {
	...
	result.SetVal(builder.IfNull(v1, v2))
	return result
}
